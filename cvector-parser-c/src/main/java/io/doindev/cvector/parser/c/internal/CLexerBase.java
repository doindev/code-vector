package io.doindev.cvector.parser.c.internal;
...
public abstract class CLexerBase extends Lexer {
    ...
    public static CharStream runGccAndMakeStream(CharStream input) {
        ...
        // Default to nopp (no preprocessing) so we don't require gcc/clang on the host.
        boolean nopp = hasArg(args, "--nopp") || !(vsc || gcc || clang);
